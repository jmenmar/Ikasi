...
fun ActivityOverview(
    ...
    Column(
        ...
        val labelColors = activities.keys.toList().map { it.color }
        val colors = listOf(MaterialTheme.colorScheme.primary.copy(alpha = 0.3f))
        ...
        RadarChart(
            ...
            labels = labels,
            colors = colors,
            labelColors = List(5) { MaterialTheme.colorScheme.onBackground },
